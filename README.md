...
1. 点上面的按钮，到下载页面，下载 **`Kynsage-x.x.x-win-x64.exe`** 这个文件（[也可以点这里直接下最新版](https://github.com/Qing-Gege/kynsage/releases/latest/download/Kynsage-0.0.10-win-x64.exe)）
...
**🍎 用 Mac 的朋友**（Apple 芯片 / M 系列）：下载 **`Kynsage-0.0.10-mac-arm64.dmg`**（[点这里直接下](https://github.com/Qing-Gege/kynsage/releases/latest/download/Kynsage-0.0.10-mac-arm64.dmg)），拖进「应用程序」即可。
...
<p align="center"><sub>▲ <b>暗色 · 专注工作</b>　三套主题随光照切换，Claude Code 的配色也跟着一起换。</sub></p>
...
- **三套主题**——暗色（专注）、护眼米色（长读）、亮色（强光），随手切换，品牌赤陶红贯穿始终。
...
<div align="center">
<br>
<sub>MIT © 2026 QingGege · 一个狗军师，三个诸葛亮</sub>
</div>
